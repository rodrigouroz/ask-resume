...
Until a dedicated security address is configured, contact Rodrigo through the contact link on the deployed résumé and include only the minimum information needed to reproduce the issue safely.
