...
export function groundingVerificationInstructions(language: Language): string {
  return [
    ...
    "If USER_QUESTION asks how a particular output or candidate is verified, ANSWER must state the evidence-backed mechanism that verifies that output or candidate; other validation practices or system features do not fulfill it.",
