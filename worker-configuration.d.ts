/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.types` (hash: ddadc77d36487ee45d625b72acb85f9c)
// Runtime types generated with workerd@1.20260820.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	AI_PROVIDER: "workers-ai";
	WORKERS_AI_MODEL: "@cf/zai-org/glm-5.3-flash";
	PROFILE_SLUG: "marina-soler";
	DAILY_ASK_LIMIT: "250";
	ASK_DAILY_BUDGET: DurableObjectNamespace<import("./worker/index").AskDailyBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "AskDailyBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "WORKERS_AI_MODEL" | "PROFILE_SLUG" | "DAILY_ASK_LIMIT">> {}
}
